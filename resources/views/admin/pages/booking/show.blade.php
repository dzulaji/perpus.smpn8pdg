                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        ...
                        <table class="table table-borderless table-detail-peminjaman">
                            ...
                            <tbody>
                                <tr>
                                    <td class="fw-medium" style="vertical-align: top;">Judul Buku</td>
                                    <td style="vertical-align: top;">:</td>
                    ...
                    <div class="card-body">
                        <form action="{{ url('/admin/booking/' . $booking->id) }}" method="post">
                            ...
                            <select class="form-select" name="status">
                                ...
                                @elseif(
                                    $booking->status == 'Disetujui' ||
                                        ($booking->expired_at < now()->startOfDay() && $booking->status != 'Dikembalikan'))
                                    <option value="Dikembalikan">Peminjaman Dikembalikan</option>
                                @endif
                            </select>
                            {{-- Tombol hanya muncul jika ada aksi yang bisa dilakukan --}}
                            @if (
                            ...
                            @else
                                <p class="mt-2 mb-0 text-muted">Tidak ada aksi yang bisa dilakukan.</p>
                            @endif
                        </form>
                    </div>
                </div>

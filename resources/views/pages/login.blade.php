        ...
        ">
            <div class="card-body py-5 px-md-5">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <h2 class="fw-bold mb-5">E-Katalog Perpustakaan SMP Negeri 8 Padang</h2>
                        <form action='/login' method="post">
                            @csrf
                            <!-- 2 column grid layout with text inputs for the first and last names -->
                            <div class="form-floating mb-3">
                                <input type="string" class="form-control" id="floatingInput" placeholder="example"
                                    name="username">
                            ...
                            <p>Belum ada akun? <a href="/register">Daftar disini!</a></p>
                        </form>
                    </div>
                </div>
            </div>

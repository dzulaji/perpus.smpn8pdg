...
*/
    ...
    helpers$1.extend(DatasetController.prototype, {
        ...
        getStyle: function (index) {
            ...
            if (dataset && index === undefined) {
                ...
                index = index || 0;
                style = me._resolveDataElementOptions(
                    meta.data[index] || {},
                    index
                );
            }
    ...
    var controller_line = core_datasetController.extend({
        ...
        _resolveDatasetElementOptions: function (element) {
            ...
            values.spanGaps = valueOrDefault$6(
                config.spanGaps,
                options.spanGaps
            );
            ...
            if (yScale.options.stacked) {
                ...
                for (i = 0; i < ilen; ++i) {
                    ...
                    if (
                        ...
                        stackedRightValue = +yScale.getRightValue(
                            ds.data[index]
                        );
    ...
    var controller_radar = core_datasetController.extend({
        ...
        _resolveDatasetElementOptions: function () {
            ...
            values.spanGaps = valueOrDefault$7(
                config.spanGaps,
                options.spanGaps
            );
    ...
    function fitBoxes(boxes, chartArea, params) {
        ...
        return refit
            ? fitBoxes(refitBoxes, chartArea, params) || changed
            : changed;
    }
        ...
        /** @lends Chart */ {
            ...
            buildOrUpdateScales: function () {
                ...
                helpers$1.each(items, function (item) {
                    ...
                    var scaleType = valueOrDefault$9(
                        scaleOptions.type,
                        item.dtype
                    );
            ...
            linear: function (tickValue, index, ticks) {
                ...
                if (tickValue !== 0) {
                    ...
                    if (maxTick < 1e-4) {
                        ...
                        numExponential = Math.max(
                            Math.min(numExponential, 20),
                            0
                        );
    ...
    function parseFontOptions(options, nestedOpts) {
        return helpers$1.extend(
            helpers$1.options._parseFont({
                fontFamily: valueOrDefault$a(
                    nestedOpts.fontFamily,
                    options.fontFamily
                ),
                fontSize: valueOrDefault$a(
                    nestedOpts.fontSize,
                    options.fontSize
                ),
                fontStyle: valueOrDefault$a(
                    nestedOpts.fontStyle,
                    options.fontStyle
                ),
                lineHeight: valueOrDefault$a(
                    nestedOpts.lineHeight,
                    options.lineHeight
                ),
            }),
            {
    ...
    function skip(ticks, spacing, majorStart, majorEnd) {
        ...
        var end = Math.min(
            valueOrDefault$a(majorEnd, ticks.length),
            ticks.length
        );
        var count = 0;
    ...
    var Scale = core_element.extend({
        ...
        fit: function () {
            ...
            if (isHorizontal) {
                ...
                minSize.width =
                    getTickMarkLength(gridLineOpts) +
                ...
                if (isHorizontal) {
                    ...
                    if (isRotated) {
                        ...
                        paddingRight = isBottom
                            ? sinRotation *
                              (lastLabelSize.height - lastLabelSize.offset)
                    ...
                    me.paddingLeft =
                        Math.max(
                            ((paddingLeft - offsetLeft) * me.width) /
                                (me.width - offsetLeft),
                            0
                        ) + 3;
                    me.paddingRight =
        ...
        _autoSkip: function (ticks) {
            ...
            var majorIndices = tickOpts.major.enabled
        ...
        _computeGridLineItems: function (chartArea) {
            ...
            for (i = 0; i < ticksLength; ++i) {
                ...
                if (
                    i === me.zeroLineIndex &&
                    options.offset === offsetGridLines
                ) {
        ...
        _computeLabelItems: function () {
            ...
            for (i = 0, ilen = ticks.length; i < ilen; ++i) {
                ...
                pixel =
                    me.getPixelForTick(tick._index || i) +
        ...
        _drawLabels: function () {
            ...
            var ctx = me.ctx;
            var items =
                me._labelItems || (me._labelItems = me._computeLabelItems());
    ...
    var scale_category = core_scale.extend({
        ...
        getPixelForValue: function (value, index, datasetIndex) {
            ...
            return me.getPixelForDecimal(
                (index - me._startValue) / me._valueRange
            );
        },
    ...
    var scale_linear = scale_linearbase.extend({
        determineDataLimits: function () {
            ...
            me.min =
                helpers$1.isFinite(me.min) && !isNaN(me.min)
                    ? me.min
                    : DEFAULT_MIN;
            me.max =
                helpers$1.isFinite(me.max) && !isNaN(me.max)
                    ? me.max
                    : DEFAULT_MAX;
    ...
    var scale_logarithmic = core_scale.extend({
        determineDataLimits: function () {
            ...
            me.minNotZero = helpers$1.isFinite(me.minNotZero)
                ? me.minNotZero
                : null;
    ...
    var scale_radialLinear = scale_linearbase.extend({
        ...
        _drawGrid: function () {
            ...
            var lineColor = valueOrDefault$c(
                angleLineOpts.color,
                gridLineOpts.color
            );
    ...
    function generate(scale, min, max, capacity) {
        ...
        for (
            time = first;
            time < max;
            time = +adapter.add(time, stepSize, minor)
        ) {
            ticks.push(time);
        }
    ...
    function computeOffsets(table, ticks, min, max, options) {
        ...
        if (options.offset && ticks.length) {
            ...
            if (ticks.length === 1) {
                ...
                start =
                    (interpolate$1(table, "time", ticks[1], "pos") - first) / 2;
            }
    ...
    var scale_time = core_scale.extend({
        ...
        getValueForPixel: function (pixel) {
            ...
            var offsets = me._offsets;
            var pos =
                me.getDecimalForPixel(pixel) / offsets.factor - offsets.end;
    ...
    core_defaults._set("global", {
            ...
            labels: {
                ...
                generateLabels: function (chart) {
                    ...
                    return chart._getSortedDatasetMetas().map(function (meta) {
                        var style = meta.controller.getStyle(
        ...
        legendCallback: function (chart) {
            ...
            for (i = 0, ilen = datasets.length; i < ilen; i++) {
                ...
                if (datasets[i].label) {
                    listItem.appendChild(
                        document.createTextNode(datasets[i].label)
                    );
                }
            }
    ...
    var Legend = core_element.extend({
        ...
        fit: function () {
            ...
            if (isHorizontal) {
                ...
                helpers$1.each(me.legendItems, function (legendItem, i) {
                    ...
                    if (
                        i > 0 &&
                        currentColHeight + fontSize + 2 * vPadding >
                            minSize.height
                    ) {
        ...
        draw: function () {
            ...
            var drawLegendBox = function (x, y, legendItem) {
                ...
                ctx.fillStyle = valueOrDefault$e(
            ...
            helpers$1.each(me.legendItems, function (legendItem, i) {
                ...
                hitboxes[i].left = rtlHelper.leftForLtr(
                    realX,
                    hitboxes[i].width
                );
                hitboxes[i].top = y;
